...
export const performanceReviews = mysqlTable("performance_reviews", {
	...
	selfRatingScore: decimal("self_rating_score", { precision: 5, scale: 2 }),
	reviewerRatingScore: decimal("reviewer_rating_score", { precision: 5, scale: 2 }),
	finalRatingScore: decimal("final_rating_score", { precision: 5, scale: 2 }),
