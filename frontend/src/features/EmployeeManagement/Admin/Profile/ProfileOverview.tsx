          ...
          <div className="p-0">
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-100">
              <div className="p-4 flex flex-col group hover:bg-[#F8F9FA]">
                ...
                <span className="text-sm font-bold text-gray-800">{profile.residentialAddress || 'Not Set'}</span>
              </div>
              <div className="p-4 flex flex-col group hover:bg-[#F8F9FA]">
                <span className="text-[10px] font-black text-gray-400 uppercase mb-1">Permanent Address</span>
                <span className="text-sm font-bold text-gray-800">{profile.permanentAddress || 'Not Set'}</span>
              </div>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-gray-100 border-t border-gray-100">
              <div className="p-4 flex items-center justify-between group hover:bg-[#F8F9FA]">
                ...
                <div className="text-right">
                    <span className="block text-sm font-bold text-gray-800">{profile.emergencyContact || 'N/A'}</span>
                    <span className="block text-xs font-semibold text-gray-500">{profile.emergencyContactNumber || ''}</span>
                </div>
              </div>
              <div className="p-4 flex flex-col group hover:bg-[#F8F9FA]">
                <span className="text-[10px] font-black text-gray-400 uppercase mb-1">Educational Background</span>
                <span className="text-sm font-bold text-gray-800 line-clamp-2">{profile.educationalBackground || 'Not Set'}</span>
              </div>
            </div>
          </div>
        </div>
