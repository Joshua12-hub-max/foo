 ...
 * @param {Array<Record<string, string>>} data - Array of objects to export
 * @param {string} title - Title for the PDF document
 */
export const exportToPDF = (data: Record<string, string>[], title = 'Leave Requests Report') => {
 ...
 * @returns {Array} Formatted data with title and rows
 */
