...
interface PerformanceNotificationProps {
  type: 'error' | 'success'; // Assuming only these two types based on logic, but could be string
  message: string;
  onClose: () => void;
}

export const PerformanceNotification: React.FC<PerformanceNotificationProps> = ({ type, message, onClose }) => {
