...
import { generateJobVacancyWord } from '@/utils/wordGenerator';
    ...
    <div className="flex flex-col h-full bg-gray-100 overflow-hidden">
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center shadow-sm z-10">
        ...
        <div className="flex gap-3">
          ...
          <button 
            onClick={() => generateJobVacancyWord(job)}
            className="px-4 py-2 text-sm font-bold text-white bg-blue-800 rounded-lg hover:bg-blue-900 transition-colors flex items-center gap-2 shadow-sm"
          >
