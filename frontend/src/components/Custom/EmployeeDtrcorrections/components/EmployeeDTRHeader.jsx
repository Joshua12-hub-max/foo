...
export const EmployeeDTRHeader = ({ today, handleRefresh, isLoading, onNewRequest }) => {
  return (
    <>
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="glass-button glass-button-primary text-white px-4 py-2 rounded-lg flex items-center gap-2 text-sm font-medium"
          >
