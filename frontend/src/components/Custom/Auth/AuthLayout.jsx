...
const AnimatedQuote = ({ quote, fadeIn }) => (
 ...
 * 
 * @param {React.ReactNode} children - Form content to display
 * @param {string} title - Page title (optional, auto-detects login/register)
 * @param {string} subtitle - Subtitle text (optional)
 * @param {string} image - Custom logo image path (optional)
 * @param {boolean} showQuotes - Toggle quote rotation (default: true)
