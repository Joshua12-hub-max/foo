    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            {leaveRequest.attachment_path && (
              <button
                ...
                className="w-full py-2.5 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
              >
                <Download size={16} />
                Download
              </button>
        ...
        <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex justify-end">
          <button
            onClick={onClose}
            className="bg-gray-200 px-6 py-2 text-sm font-medium text-gray-600 hover:bg-gray-100 rounded-lg shadow-md transition-colors"
          >
            Close
          </button>
        </div>
