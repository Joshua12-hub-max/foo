...
export default function PresentTable({ onClose, employees = [] }) {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-bold text-gray-800">Present Employees</h2>
          <p className="text-sm text-gray-800 mt-1">Currently logged in employees</p>
        </div>
        <button
          onClick={onClose}
              ...
              {currentEmployees.length ? (
                currentEmployees.map((employee) => (
                  <tr key={employee.id} className="hover:bg-[#34645c] transition-colors">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-800">{employee.timeOut}</td>
