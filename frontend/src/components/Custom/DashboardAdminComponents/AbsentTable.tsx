        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-200 shadow-md text-gray-700">
            <tr>
              ...
              <th className="px-4 py-4 text-left text-sm font-bold tracking-wide whitespace-nowrap">Date</th>
            </tr>
          </thead>
            ...
            {currentEmployees.length ? (
              currentEmployees.map(employee => (
                <tr key={employee.id} className="hover:bg-[#F8F9FA] hover:shadow-xl transition-colors group bg-white">
                  ...
                  <td className="px-4 py-4 text-sm text-gray-700 whitespace-nowrap">{employee.date}</td>
                </tr>
              ))
            ) : (
              <tr>
