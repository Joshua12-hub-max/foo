/**
 * DepartmentEmployeeTable Component
 * Employee table for department detail view
 */

import React, { memo, useMemo, useCallback } from 'react';
import { Users, Phone, Edit2, Trash2, Calendar } from 'lucide-react';
    ...
    <tr className="hover:bg-gray-50 transition-colors">
      ...
      <td className="px-6 py-4">
        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
          employee.employment_status === 'Active' ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
        }`}>
