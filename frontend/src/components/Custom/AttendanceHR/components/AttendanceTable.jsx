...
import { TABLE_HEADERS } from '../Constants/AttendanceConstant';
import { getStatusBadge } from '../Utils/AttendanceUtils';

const AttendanceTable = ({ currentItems, debouncedSearchQuery, filters }) => {
  const hasActiveFilters = debouncedSearchQuery || Object.values(filters).some(v => v);

  return (
    <div className="flex-1 scrollbar-bg-white overflow-hidden rounded-xl bg-white p-1">
      <div className="scrollbar-bg-white overflow-x-auto rounded-lg">
