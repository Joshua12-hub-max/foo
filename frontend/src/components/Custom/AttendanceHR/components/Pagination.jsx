    ...
    <div className="flex justify-between items-center mt-6">
      ...
      <div className="flex items-center space-x-2">
        <button
          ...
          className="px-4 py-2 bg-white border border-gray-300 rounded-lg shadow-md disabled:opacity-50 hover:bg-gray-50 transition-all text-sm font-medium text-gray-800"
        >
          Previous
        </button>
