...
//       const headers = ['Department", "Employee ID", "Employee Name", "Date","Present", "Absent", "Late", "On Leave", "Leave With Pay", "Leave Without Pay", "Work From Home", "Undertime", "Overtime"," Lunch In", "Lunch Out", "Break In", "Break Out", "Time In", "Time Out", "Half Day", "Total Hours", "Total Work", "Status","Notes"'];
//       const csvContent = [
//         headers.join(','),
...
//       'On Leave': 'bg-blue-800 text-blue-800',
//       'work from home': 'bg-blue-800 text-blue-800',
//       'Undertime': 'bg-blue-800 text-blue-800',
//       'Overtime': 'bg-blue-800 text-blue-800',
...
//               <tr>
//                 {["Department", "Employee ID", "Employee Name", "Date","Present", "Absent", "Late", "On Leave", "Leave With Pay", "Leave Without Pay", "Work From Home", "Undertime", "Overtime"," Lunch In", "Lunch Out", "Break In", "Break Out", "Time In", "Time Out", "Half Day", "Total Hours", "Total Work", "Status","Notes"].map((header) => (
...
//                     <td className="px-6 py-4 text-sm text-gray-800">{item.TimekOut}</td>
