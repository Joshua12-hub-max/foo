...
const PerformanceCriteriaContent = () => {
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredCriteria.map((item) => {
            ...
            const borderColor = borderColors[item.category] || 'border-l-gray-300';
            ...
            return (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-gray-800 mb-2 leading-tight">{item.title}</h3>
                <p className="text-gray-500 text-xs mb-4 line-clamp-3 leading-relaxed min-h-[3em]">{item.description}</p>
