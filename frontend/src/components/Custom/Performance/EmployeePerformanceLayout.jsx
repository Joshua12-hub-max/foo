/**
 * EmployeePerformanceLayout - Tabbed layout for Employee Performance Section
 * Matches the Admin Portal's PerformanceLayout design
 */

import React from 'react';
import { useNavigate, useLocation, useOutletContext } from 'react-router-dom';

const EmployeePerformanceLayout = ({ children }) => {
