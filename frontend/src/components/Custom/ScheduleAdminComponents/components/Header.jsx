...
const Header = ({ today, isLoading, onRefresh }) => (
  <div className="flex justify-between items-center mb-6">
    <div>
      <h2 className="text-2xl font-bold text-gray-800">Employee Schedule</h2>
      <p className="text-sm text-gray-800 mt-1">Schedule management system</p>
    </div>
