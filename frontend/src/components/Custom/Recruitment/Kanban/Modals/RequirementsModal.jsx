...
const RequirementsModal = memo(({ isOpen, onClose, applicant }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-xl w-full max-w-lg shadow-xl my-8 border border-gray-100 flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
        {/* Clean Header */}
