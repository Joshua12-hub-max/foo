...
import { FILE_CONFIG } from '@/components/Custom/Timekeeping/LeaveRequestComponents/Employee/Modals/constants/modalConstants';
...
export const FileUpload: React.FC<FileUploadProps> = ({ file, onFileChange, onRemove, error }) => {
  ...
  return (
    <div>
      <label className="block text-xs font-semibold text-gray-700 mb-1.5">
        Attach Supporting Documents <span className="text-red-500">*</span>
      </label>
