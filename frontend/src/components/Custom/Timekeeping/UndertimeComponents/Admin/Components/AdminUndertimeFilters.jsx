      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 items-center">
        ...
        <div className="flex gap-2 md:col-span-2">
          <button
            onClick={handleApply}
            disabled={isLoading}
            className="flex-1 flex items-center justify-center bg-[#F8F9FA] text-gray-700 font-medium px-6 py-2 rounded-lg text-sm shadow-sm hover:bg-[#F8F9FA] transition-all disabled:opacity-50 active:scale-95 border border-gray-200"
          ...
          <button
            onClick={handleClear}
            disabled={isLoading}
            className="flex-1 bg-[#F8F9FA] text-gray-700 font-medium px-6 py-2 rounded-lg text-sm shadow-sm hover:bg-[#F8F9FA] transition-all disabled:opacity-50 active:scale-95 border border-gray-200"
...
export default AdminUndertimeFilters;
