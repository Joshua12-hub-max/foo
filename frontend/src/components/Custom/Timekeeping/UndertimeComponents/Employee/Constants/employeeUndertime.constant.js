...
export const MESSAGES = {
  ...
  ERROR_CANCEL: 'Failed to cancel request. Please try again.',
  SUCCESS_SUBMIT: 'Undertime request submitted successfully!',
  SUCCESS_CANCEL: 'Request cancelled successfully!'
};
