...
export const AssignModal = React.memo(({ isOpen, onClose, currentPosition, availableEmployees, selectedEmployee, setSelectedEmployee, onAssign }) => {
          ...
          <div className="bg-white rounded-xl border-2 border-gray-200 w-full max-w-md shadow-xl p-6">
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <button 
                  onClick={onAssign}
                  className="flex-1 px-4 py-2 text-sm font-semibold text-white bg-gray-900 rounded-lg shadow-md hover:bg-gray-800"
                >
                  Assign
                </button>
              </div>
...
export const VacateModal = React.memo(({ isOpen, onClose, currentPosition, vacateReason, setVacateReason, onVacate }) => {
    if (!isOpen) return null;
    return (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl border-2 border-gray-200 w-full max-w-md shadow-xl p-6">
            ...
            <div>
              ...
              <div className="flex gap-3">
                ...
                <button 
                  onClick={onVacate}
                  className="flex-1 px-4 py-2 text-sm font-semibold text-white bg-amber-600 rounded-lg shadow-md hover:bg-amber-700"
                >
                  Vacate
                </button>
              </div>
...
export const HistoryModal = React.memo(({ isOpen, onClose, currentPosition, positionHistory }) => {
    if (!isOpen) return null;
...
export const GuideModal = React.memo(({ isOpen, onClose }) => {
    if (!isOpen) return null;
    return (
        <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
