...
const EditProfileModal = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/30 flex items-start justify-center z-50 p-4">
      <div className="bg-white rounded-lg w-full max-w-md shadow-xl mt-16 border border-gray-200">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              <label className="absolute bottom-0 right-0 w-7 h-7 bg-gray-100 rounded-full flex items-center justify-center cursor-pointer hover:bg-gray-200 shadow transition-colors border border-gray-200">
          ...
          <div className="flex gap-3 pt-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-4 py-2.5 text-sm text-gray-600 bg-gray-200 hover:bg-gray-300 rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-1"
            >
              {loading ? (
