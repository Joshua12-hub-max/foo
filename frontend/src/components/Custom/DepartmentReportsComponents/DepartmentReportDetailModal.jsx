...
/**
 * Detail modal component showing individual employee records for a department
 */
export const DepartmentReportDetailModal = ({
  isOpen,
  department,
  data,
  isLoading,
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center rounded-xl overflow-hidden">
      ...
      {/* Modal */}
      <div className="relative bg-white rounded-xl shadow-2xl w-full max-w-5xl mx-4 max-h-[85vh] flex flex-col overflow-hidden">
        {/* Header */}
        <div className="bg-gray-200 px-6 py-4 flex justify-between items-center">
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 flex items-center justify-center rounded-lg hover:bg-gray-300 text-gray-600 hover:text-gray-800 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-between items-center">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-sm"
              >
