    ...
    <div className="bg-[#F8F9FA] p-4 rounded-lg shadow-md mb-6">
      <div className="grid grid-cols-1 md:grid-cols-6 gap-4 items-center">
        ...
        <button
          onClick={handleClear}
          disabled={isLoading}
          className="bg-gray-200 text-gray-700 font-medium px-4 py-2 rounded-lg text-sm shadow-sm hover:bg-gray-300 transition-all disabled:opacity-50 active:scale-95"
