...
export const useNotificationHistory = () => {
  ...
  const handleClear = () => {
    setFilters({ department: '', employee: '', startDate: '', endDate: '' });
    setCurrentPage(1);
  };
  ...
  const handleExportCSV = () => {
    ...
    const headers = ['Date', 'Title', 'Message', 'Type', 'Recipient', 'Status'];
  ...
  const generatePDF = (data, appliedFilters) => {
    ...
    const filterInfo = [];
    if (appliedFilters.department) filterInfo.push(`Department: ${appliedFilters.department}`);
    ...
    printWindow.document.write(`
      ...
      <html>
      <head>
        <title>Notification History Report</title>
        <style>
      ...
      <body>
        <h1>Notification History Report</h1>
        <div class="info">
