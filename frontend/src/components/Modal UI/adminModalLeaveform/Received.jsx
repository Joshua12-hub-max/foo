...
const RecieveFormModal = ({ isOpen, form, remarks, onRemarksChange, onReceive, onCancel }) => {
        ...
        >
          ...
          <div className="bg-gradient-to-r from-slate-950 to-green-700 flex items-center justify-between p-4 border-b relative">
            <div className="flex items-center gap-2 z-10">
              ...
              <h2 className="text-xl font-bold text-white">Receive Leave Form</h2>
            </div>
            <button
              type="button"
                ...
                <div className="mb-5 border-2 border-green-200 rounded-xl p-4 bg-gradient-to-br from-green-50 to-white shadow-sm">
                  ...
                  <div className="bg-white rounded-lg p-4 border-2 border-green-300">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-semibold text-gray-900">
                            {form.fileName || "Filled_Leave_Form.pdf"}
                          </p>
                      ...
                      <a
                        href={form.formFile}
                        download={form.fileName || "Filled_Leave_Form.pdf"}
              ...
              {form && (
                <div className="mb-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    {form.leaveType} • {form.days || 0} day(s)
                  </p>
                </div>
              )}
              ...
              <>
                <div className="text-center pt-4">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Are you sure you want to receive this leave form?
                  </p>
                  {remarks && (
...
export default RecieveFormModal;