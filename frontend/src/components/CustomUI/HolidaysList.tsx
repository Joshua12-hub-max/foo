...
import { getEventStyles } from '@/components/Custom/CalendarComponents/shared/utils/calendarItemUtils';
...
const HolidayItem = memo(({ title, date, type }: ItemProps) => {
...
/* -------------------- Main Holidays List -------------------- */
function HolidaysList({ holidays = [] }: HolidaysListProps) {
  if (!holidays.length) {
    return (
