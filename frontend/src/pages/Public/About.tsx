      ...
      <div className="flex-1 w-full bg-slate-50 relative overflow-hidden">
        ...
        <main className="max-w-5xl mx-auto px-6 pt-12 pb-20 relative z-10">
            ...
            >
                  ...
                  <h1 className="text-3xl sm:text-4xl md:text-6xl font-black text-slate-900 mb-6 tracking-tighter leading-none">
                     Our Core <span className="text-green-600">Mission</span>
                  </h1>
                  <p className="text-base md:text-lg text-slate-600 max-w-2xl mx-auto font-semibold leading-relaxed">
            ...
            <div id="section-mission-vision" className="grid md:grid-cols-2 gap-6 mb-16">
                <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 text-slate-900 relative overflow-hidden shadow-2xl group border border-slate-200"
                >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                        <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center mb-8 border border-slate-100 group-hover:border-green-400/50 transition-colors">
                            <Target size={24} className="text-green-600" />
                        </div>
                        <h2 className="text-2xl font-black mb-4 tracking-tight text-slate-900">Our Mission</h2>
                        <p className="text-slate-600 leading-relaxed text-[15px] font-semibold mb-6">
                        ...
                        <div className="mt-auto h-40 -mx-10 -mb-10 bg-slate-50 overflow-hidden group-hover:h-48 transition-all duration-700 relative text-white">
                           <img 
                                src={missionImg} 
                                alt="Mission Visual" 
                                className="w-full h-full object-cover opacity-20 group-hover:opacity-60 group-hover:scale-110 transition-all duration-700" 
                           />
                ...
                <motion.div 
                     ...
                     className="bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-10 text-slate-900 relative overflow-hidden border border-slate-200 shadow-premium group"
                >
                     ...
                     <div className="relative z-10 h-full flex flex-col">
                        ...
                        <h2 className="text-2xl font-black mb-4 tracking-tight text-slate-900">Our Vision</h2>
                        <p className="text-slate-600 leading-relaxed text-[15px] font-semibold mb-6">
            ...
            <div id="section-why-us" className="space-y-10">
                <div className="flex items-center gap-6">
                    <div className="h-px flex-1 bg-slate-200"></div>
                        <span className="text-[10px] font-bold text-green-600 tracking-tight">About Meycauayan</span>
                    <div className="h-px flex-1 bg-slate-200"></div>
                </div>
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ...
                        <motion.div 
                            ...
                            className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-premium hover:border-green-500/30 transition-all duration-300 group"
                        >
                            <div className="w-9 h-9 bg-slate-50 rounded-lg flex items-center justify-center mb-4 text-slate-400 group-hover:bg-green-600 group-hover:text-white transition-all duration-500">
                                {item.icon}
                            </div>
                            <h3 className="font-black text-[14px] text-slate-900 mb-2 tracking-tight">{item.title}</h3>
            ...
            <div className="mt-20 p-1 bg-slate-100/50 rounded-3xl">
                <div className="bg-white rounded-[1.4rem] p-8 text-center border border-slate-200">
                    <p className="text-slate-400 text-[11px] font-bold tracking-tight mb-4">Public service integrity</p>
                    <div className="flex items-center justify-center gap-2 text-slate-900 font-black text-lg tracking-tight">
