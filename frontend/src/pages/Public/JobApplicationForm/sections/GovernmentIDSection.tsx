...
const GovernmentIDSection: React.FC<GovernmentIDSectionProps> = ({ register, errors, setValue }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        ...
        <div>
          ...
          <input
            ...
            maxLength={11}
          />
          <p className="text-[10px] text-gray-500 mt-1 ml-1">Format: 12345678901 (11 digits)</p>
          {errors.gsisNumber && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.gsisNumber.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={12}
          />
          <p className="text-[10px] text-gray-500 mt-1 ml-1">Format: 1234-567890-1 (12 digits)</p>
          {errors.pagibigNumber && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.pagibigNumber.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={14}
          />
          <p className="text-[10px] text-gray-500 mt-1 ml-1">Format: 12-345678901-2</p>
          {errors.philhealthNumber && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.philhealthNumber.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={14}
          />
          <p className="text-[10px] text-gray-500 mt-1 ml-1">Format: 1234-5678901-2</p>
          {errors.umidNumber && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.umidNumber.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={19}
          />
          <p className="text-[10px] text-gray-500 mt-1 ml-1">Format: 1234-5678-9012-3456</p>
          {errors.philsysId && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.philsysId.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          <input
            ...
            maxLength={15}
          />
          <p className="text-[10px] text-gray-500 mt-1 ml-1">Format: 123-456-789-000</p>
          {errors.tinNumber && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.tinNumber.message}</p>
          )}
        </div>
      </div>
