...
const PersonalInfoSection: React.FC<PersonalInfoSectionProps> = ({ register, errors }) => {
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          />
          {errors.middleName && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.middleName.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.suffix && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.suffix.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          />
          {errors.birthDate && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.birthDate.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.birthPlace && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.birthPlace.message}</p>
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
        <div>
          ...
          {errors.sex && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.sex.message}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.civilStatus && (
            <p className="text-red-500 text-xs mt-1 ml-1">{errors.civilStatus.message}</p>
          )}
        </div>
      </div>
