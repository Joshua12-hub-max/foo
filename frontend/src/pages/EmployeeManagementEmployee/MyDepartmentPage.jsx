...
import { useEmployeeDepartment } from '@components/Custom/EmployeeManagement/Employee/Portal/Department/useEmployeeDepartment';
import { useAuth } from '@hooks/useAuth';

const MyDepartmentPage = ({ hideHeader = false }) => {
  ...
  const myRecord = colleagues.find(emp => String(emp.id) === String(user?.id) || emp.email === user?.email);
