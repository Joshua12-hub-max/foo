...
// Import components
import EmployeeDepartment from '@/pages/EmployeeManagementEmployee/MyDepartmentPage';
import EmployeeMemos from '@/pages/EmployeeManagementEmployee/MyMemosPage';

const OrganizationalHubPage = () => {
