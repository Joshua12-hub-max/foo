...
const EmployeeDailyTimeRecord = () => {
  ...
  // Mock data for employee's own records
  const [dtrData] = useState([
    { id: "1", date: "2024-11-01", timeIn: "08:00 AM", timeOut: "05:00 PM", hoursWorked: "9.0", status: "Present", remarks: "On time" },
    { id: "2", date: "2024-11-02", timeIn: "08:15 AM", timeOut: "05:00 PM", hoursWorked: "8.75", status: "Present", remarks: "Late" },
    { id: "3", date: "2024-11-03", timeIn: "08:00 AM", timeOut: "05:00 PM", hoursWorked: "9.0", status: "Present", remarks: "On time" },
    { id: "4", date: "2024-11-04", timeIn: "08:00 AM", timeOut: "05:00 PM", hoursWorked: "9.0", status: "Present", remarks: "On time" },
    { id: "5", date: "2024-11-05", timeIn: "08:00 AM", timeOut: "05:00 PM", hoursWorked: "9.0", status: "Present", remarks: "On time" },
    { id: "6", date: "2024-11-06", timeIn: "08:00 AM", timeOut: "05:00 PM", hoursWorked: "9.0", status: "Present", remarks: "On time" },
    { id: "7", date: "2024-11-07", timeIn: "08:00 AM", timeOut: "05:00 PM", hoursWorked: "9.0", status: "Present", remarks: "On time" },
    { id: "8", date: "2024-11-08", timeIn: "08:00 AM", timeOut: "05:00 PM", hoursWorked: "9.0", status: "Present", remarks: "On time" },
  ]);
  ...
  const handleExportCSV = useCallback(async () => {
    ...
    try {
      ...
      const headers = ['Status', 'Date', 'Time In', 'Time Out', 'Hours Worked', 'Remarks'];
      const csvContent = [
        headers.join(','),
      ...
      link.setAttribute('download', `my_dtr_${today.replace(/\//g, '-')}.csv`);
      ...
      let htmlContent = `
        ...
        <body>
          ...
          <div class="employee-info">
            <strong>Employee:</strong> ${currentEmployee.name} (${currentEmployee.id})<br>
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-neutral-100 to-stone-100 rounded-xl shadow-xl p-7 w-full overflow-hidden text-gray-800">
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-800 mt-1">View your time records</p>
        </div>
        ...
        <div className="overflow-x-auto bg-gray-50 rounded-lg">
          <table className="w-full min-w-[1000px]">
            <thead className="bg-[#274b46] text-[#F8F9FA]">
              <tr>
                {["Status", "Date", "Time In", "Time Out", "Hours Worked", "Remarks"].map((header) => (
